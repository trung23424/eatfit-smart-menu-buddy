...
const MealDetailModal = ({ meal, isOpen, onClose, onToggleFavorite }: MealDetailModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-40 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl w-full max-w-sm max-h-[90vh] shadow-2xl animate-scale-in overflow-hidden flex flex-col">
        {/* Header */}
        <div className="relative px-4 py-3 border-b border-gray-100 flex-shrink-0">
          <button
            onClick={onClose}
